...
export const assetCatalog: AssetCatalogEntry[] = [
  ...
  },
  {
    ...
    displayName: "Cardano",
    coinGeckoId: "cardano",
    newsKeywords: ["cardano", "ADA", "altcoins"],
    basePrice: 0.74,
    baseSentiment: 0.09,
  },
  {
    ...
    displayName: "XRP",
    coinGeckoId: "ripple",
    newsKeywords: ["xrp", "ripple", "cross border payments"],
    basePrice: 0.62,
    baseSentiment: 0.04,
  },
  {
    ...
    newsKeywords: ["bnb", "binance", "exchange token"],
    basePrice: 588,
    baseSentiment: 0.13,
  },
  {
  ...
  },
  {
    ...
    newsKeywords: ["avalanche", "AVAX", "layer 1"],
    basePrice: 42.6,
    baseSentiment: 0.07,
  },
  {
  ...
  },
  {
    ...
    newsKeywords: ["USDCAD", "loonie", "Bank of Canada"],
    basePrice: 1.3526,
    baseSentiment: -0.06,
  },
  {
    ...
    newsKeywords: ["AUDUSD", "aussie dollar", "RBA"],
    basePrice: 0.6584,
    baseSentiment: 0.08,
  },
  {
    ...
    newsKeywords: ["USDCHF", "swiss franc", "SNB"],
    basePrice: 0.8823,
    baseSentiment: -0.04,
  },
  {
    ...
    newsKeywords: ["NZDUSD", "kiwi dollar", "RBNZ"],
    basePrice: 0.6112,
    baseSentiment: 0.03,
  },
  {
    ...
    newsKeywords: ["EURGBP", "euro sterling", "ECB BOE"],
    basePrice: 0.8564,
    baseSentiment: 0.02,
  },
  {
    ...
    newsKeywords: ["EURJPY", "euro yen", "ECB BOJ"],
    basePrice: 165.74,
    baseSentiment: 0.12,
  },
  {
    ...
    newsKeywords: ["EURCHF", "euro swiss franc", "ECB SNB"],
    basePrice: 0.9581,
    baseSentiment: 0.01,
  },
  {
    ...
    newsKeywords: ["USDKES", "kenyan shilling", "CBK"],
    basePrice: 129.36,
    baseSentiment: -0.09,
  },
];
...
export const mockWatchlistAssets: Array<{
  ...
  assetCatalog.slice(0, 8).map((asset, index) => ({
    id: `asset-${index + 1}`,
